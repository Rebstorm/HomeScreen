 ...
 *
 */
public class LightFragment extends Fragment implements PlayerNotificationCallback, ConnectionStateCallback {
    ...
    public void onResume(){
        ...
        if (mPlayer != null) {
            mPlayer.addPlayerNotificationCallback(LightFragment.this);
            mPlayer.addConnectionStateCallback(LightFragment.this);
        }
